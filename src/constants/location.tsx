...
export const PRICES = [
    { location:'Hall', destination:'Dept. Building', price: 200  },
    { location:'Dept. Building', destination:'Hall',  price: 200 },
    ...
    { location:'Cafeteria 2', destination:'Shuttle Stand',  price: 150 },
