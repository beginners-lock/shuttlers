...
import { ERROR500, ERROR700, NEUTRAL500, SECONDARY500, SECONDARY800, SECONDARY900, SUCCESS500 } from '../theme/colors';
...
export default function Driver(){
    ...
    return(
        <div className="relative w-full h-full flex flex-col items-center justify-start">
            ...
            <div className="relative mt-6 w-[95%] h-[180px] rounded-lg shadow-lg box-border px-4 py-4 flex flex-col items-start justify-between" style={{backgroundImage:'linear-gradient(to bottom right, #002B67 0%, #25818B 70%, #5FAA62 100%)'}}>
            ...
            <div className='px-2 mt-8 font-poppins'>
                ...
                <div className='mt-6 px-2 flex flex-col items-center justify-start text-center text-sm' style={{color:NEUTRAL500}}>
                    {
                        online ? 
                            ''
                        :
