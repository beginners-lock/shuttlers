...
export default function DNavbar(){
    ...
    return(
        <div className="flex flex-row justify-between items-center fixed bottom-4 w-[300px] h-12 rounded-full px-4 py-2 box-border" style={{backgroundColor: SECONDARY900}}>
            <div className="rounded-full flex flex-row items-center justify-start px-2 py-1.5" style={{backgroundColor:window.location.pathname==='/driver/dashboard'?'#FFFFFF4D':'transparent'}} onClick={()=>{ window.location.href='/driver/dashboard'; }}>
            ...
            <div className="rounded-full flex flex-row items-center justify-start px-2 py-1.5" style={{backgroundColor:window.location.pathname==='/driver/trips'?'#FFFFFF4D':'transparent'}} onClick={()=>{ window.location.href='/driver/trips'; }}>
            ...
            <div className="rounded-full flex flex-row items-center justify-start px-2 py-1.5" style={{backgroundColor:window.location.pathname==='/driver/settings'?'#FFFFFF4D':'transparent'}} onClick={()=>{ window.location.href='/driver/settings'; }}>
